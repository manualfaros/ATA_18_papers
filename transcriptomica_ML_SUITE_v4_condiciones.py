...
try:
    ...
    CONDITION_GROUPS = {
        ...
        "Stress_like": ["PeyrussonVlaemink", "Feng", "Bastock", "Im", "Chaves"],
...
with tabs[4]:
    ...
    st.markdown("""
    Tres métodos complementarios para inferir función de los 90 genes SaSP:
    ...
    > (ej. *Energy metabolism + Amino acid metabolism + …  →  Metabolism*) para que cada
    > clase tenga suficientes ejemplos de entrenamiento y las predicciones sean más robustas.
    """)
...
# ── sidebar info ──
st.sidebar.markdown("---")
st.sidebar.info("**S. aureus Transcriptómica**\nVolcano · Gen · Heatmaps · ML Suite · Coexpresión")
